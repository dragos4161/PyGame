...
def move_yellow_spaceship(yellow, keys_pressed):
    # YELLOW SPACESHIP
...
def move_red_spaceship(red, keys_pressed):
    # RED SPACESHIP
...
def main():
    ...
    red = pygame.Rect(745, (HEIGHT - SPACESHIP_HEIGHT) // 2, SPACESHIP_WIDTH, SPACESHIP_HEIGHT)
    yellow = pygame.Rect(100, (HEIGHT - SPACESHIP_HEIGHT) // 2, SPACESHIP_WIDTH, SPACESHIP_HEIGHT)
